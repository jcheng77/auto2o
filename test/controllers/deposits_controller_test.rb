...
class DepositsControllerTest < ActionController::TestCase
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post :create, deposit: { status: @deposit.status, sum: @deposit.sum, tender_id: @deposit.tender_id, user_id: @deposit.user_id }
    end
  ...
  test "should update deposit" do
    patch :update, id: @deposit, deposit: { status: @deposit.status, sum: @deposit.sum, tender_id: @deposit.tender_id, user_id: @deposit.user_id }
    assert_redirected_to deposit_path(assigns(:deposit))
  end
